...
const _hoisted_11$1 = { class: "sf-array-item-actions" };
const _hoisted_12$1 = ["onClick"];
const _hoisted_13$1 = ["onClick"];
const _hoisted_14$1 = ["onClick"];
const _hoisted_15$1 = ["onDrop"];
const _hoisted_16 = {
  key: 0,
  class: "errorlist"
};
    ...
    createBaseVNode("div", _hoisted_5$3, [
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.items, (item, index) => {
        return (openBlock(), createElementBlock("div", {
          ...
          ], 40 /* PROPS, NEED_HYDRATION */, _hoisted_15$1)
...
const _hoisted_4$1 = { class: "sf-relation-tag-text" };
const _hoisted_5$1 = ["onClick"];
const _hoisted_6 = { class: "sf-relation-search" };
...
const _hoisted_11 = { class: "sf-relation-item-content" };
const _hoisted_12 = { class: "sf-relation-item-name" };
const _hoisted_13 = {
  key: 0,
  class: "sf-relation-item-description"
};
const _hoisted_14 = {
  key: 1,
  class: "sf-relation-dropdown-loading"
};
const _hoisted_15 = {
  key: 0,
  class: "errorlist"
    ...
    createBaseVNode("div", _hoisted_1$2, [
        ...
        ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($data.selected, (item) => {
              return (openBlock(), createElementBlock("div", {
                ...
                ($options.getItemImage(item))
                  ? (openBlock(), createElementBlock("img", {
                      key: 0,
                      class: "sf-relation-tag-image",
                      src: $options.getItemImage(item),
                      alt: "",
                      loading: "lazy"
                    }, null, 8 /* PROPS */, _hoisted_3$1))
                  : createCommentVNode("v-if", true),
                createBaseVNode("span", _hoisted_4$1, toDisplayString($options.getDisplayName(item)), 1 /* TEXT */),
      ...
      withDirectives(createBaseVNode("div", _hoisted_6, [
        ...
        withDirectives(createBaseVNode("div", {
          class: "sf-relation-dropdown",
          ref: "dropdown",
          onScroll: _cache[4] || (_cache[4] = (...args) => ($options.onDropdownScroll && $options.onDropdownScroll(...args)))
        }, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.filteredResults, (item, i) => {
            return (openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("span", _hoisted_11, [
                createBaseVNode("span", _hoisted_12, toDisplayString($options.getDisplayName(item)), 1 /* TEXT */),
                ($options.getItemDescription(item))
                  ? (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString($options.getItemDescription(item)), 1 /* TEXT */))
                  : createCommentVNode("v-if", true)
              ])
            ], 10 /* CLASS, PROPS */, _hoisted_9))
          }), 128 /* KEYED_FRAGMENT */)),
          ($data.loading)
            ? (openBlock(), createElementBlock("div", _hoisted_14, "Loading…"))
            : createCommentVNode("v-if", true)
